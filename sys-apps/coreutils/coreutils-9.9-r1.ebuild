...
src_prepare() {
	...
	local PATCHES=(
		...
		"${FILESDIR}"/0001-uname-Add-processor-hardware-platform-option.patch
		"${FILESDIR}"/0002-tests-sandbox-fixes.patch
		"${FILESDIR}"/0003-dircolors-Add-more-dir-file-colors.patch
		"${FILESDIR}"/0004-cp-ignore-EEXIST-errors-from-mkdir.patch
	)
